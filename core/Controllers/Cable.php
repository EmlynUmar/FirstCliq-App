<?php
    ...
    class Cable extends ApiAccess{
		...
		public function validateIUCNumber($body,$cableid,$provider){
            ...
            //Get Ap Details
            $host = $this->getConfigValue($details,"cableVerificationProvider");
            $apiKey = $this->getConfigValue($details,"cableVerificationApi");
            ...
            elseif (strpos($host, 'nabaulu') !== false){
                $aunType = "Basic";
                $host = $host . "?iuc=".$body->iucnumber."&cable=".$cableid;
            }
        ...
        public function purchaseCableTv($body,$cableid,$provider,$cableplan){
            ...
            $host = $this->getConfigValue($details,"cableProvider");
            $apiKey = $this->getConfigValue($details,"cableApi");
