...
<center>   <a type="button"href="https://www.mediafire.com/file/ala6uxo89nxa9ga/dataflexng.apk/file"><img  style="height:100px;"src="https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png"/></a></center>

</br></br></br>


    <div class="card mt-n5" style="border-top-left-radius: 3rem !important; border-top-right-radius: 3rem !important; padding:20px; height:65vh;background-color:;">

        <div class="d-flex justify-content-between align-content-center mt-2 mb-2">
            
             <a href="buy-data" class="card text-center " style="width:100% !important; margin:7px; border-radius:1rem; background:rgba(204, 0, 102,0.1);"> 
            ...
            <a href="buy-airtime" class="card text-center" style="width:100% !important; margin:7px; border-radius:1rem; background:rgba(0, 102, 255,0.1);">
   ...
   <a href="cable-tv" class="card text-center " style="width:100% !important; margin:7px; border-radius:1rem; background:rgba(0, 204, 0,0.1);">
         ...
         <div class="d-flex justify-content-between align-content-center mb-2">
              ...
              <a href="verify-nin" class="card text-center " style="width:100% !important; margin:7px; border-radius:1rem; background:rgba(10, 274, 10,0.5);">
                <span class="icon icon-s pt-1" style="color:blue;">
                    <i class="fa fa-id-card font-25"></i>
                </span>
                <p class="mb-2 pt-1 font-13 text-dark"><b>Verify NIN</b></p>
            </a>
            
            <a href="verify-pnv" class="card text-center " style="width:100% !important; margin:7px; border-radius:1rem; background:rgba(10, 274, 10,0.5);">
                <span class="icon icon-s pt-1" style="color:blue;">
                    <i class="fa fa-id-card font-25"></i>
                </span>
                <p class="mb-2 pt-1 font-13 text-dark"><b>NIN With Phone</b></p>
            </a>
             <a href="verify-bvn" class="card text-center " style="width:100% !important; margin:7px; border-radius:1rem; background:rgba(10, 274, 10,0.5);">
                <span class="icon icon-s pt-1" style="color:blue;">
                    <i class="fa fa-id-card font-25"></i>
                </span>
                <p class="mb-2 pt-1 font-13 text-dark"><b>Verify BVN</b></p>
            </a>
        ...
        <div class="d-flex justify-content-between align-content-center mb-2">
            ...
            <a href="electricity" class="card text-center " style="width:100% !important; margin:7px; border-radius:1rem; background:rgba(204, 0, 102,0.1);">
                <span class="icon icon-s pt-1" style="color:#cc0066;">
            ...
            <a href="exam-pins" class="card text-center " style="width:100% !important; margin:7px; border-radius:1rem; background:rgba(0, 102, 255,0.1);">
                <span class="icon icon-s pt-1" style="color:#0066ff;">
            ...
            <a href="buy-data-pin" class="card text-center " style="width:100% !important; margin:7px; border-radius:1rem; background:rgba(0, 204, 0,0.1);">
                <span class="icon icon-s pt-1" style="color:#00cc00;">
        ...
        <div class="d-flex justify-content-between align-content-center mb-2">
            ...
            <a href="airtime-to-cash" class="card text-center " style="width:100% !important; margin:7px; border-radius:1rem; background:rgba(204, 0, 102,0.1);">
                <span class="icon icon-s pt-1" style="color:#cc0066;">
            ...
            <a href="referrals" class="card text-center " style="width:100% !important; margin:7px; border-radius:1rem; background:rgba(0, 102, 255,0.1);">
                <span class="icon icon-s pt-1" style="color:#0066ff;">
            ...
            <a href="logout" class="card text-center " style="width:100% !important; margin:7px; border-radius:1rem; background:rgba(0, 204, 0,0.1);">
                <span class="icon icon-s pt-1" style="color:#00cc00;">
