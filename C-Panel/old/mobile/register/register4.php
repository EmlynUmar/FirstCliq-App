            ...
            <div class="content">
                ...
                <div class="px-2">
                    ...
                    <div class="input-style  no-borders has-icon mb-4">
                        ...
                        <input type="text"maxlength="10" class="form-control" id="fname" name="fname" placeholder="First Name" required />
                    ...
                    <div class="input-style  no-borders has-icon mb-4">
                        <i class="fa fa-user"></i>
                        <input type="text"maxlength="10" class="form-control" id="lname" name="lname" placeholder="Last Name" required />
