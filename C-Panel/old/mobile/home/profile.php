                    ...
                    <p class="mb-n1 color-highlight font-600 font-12">Account Details</p>
                        ...
                        <div class="list-group list-custom-small">
                            ...
                            <a href="#">
                                ...
                                <button class="btn btn-success btn-sm" onclick="window.location.href='referrals'">View Commission</button>
                            </a>
                        </div>
                        ...
                        <div class="list-group list-custom-small">
                            ...
                            <a href="#">
                                ...
                                <?php if(!empty($data2)): ?>
                                    <button class="pl-5 btn btn-success btn-sm" onclick="window.location.href='<?php echo $data2->apidocumentation; ?>'">View Documentation</button>
                                <?php endif; ?>
                            </a>
                         </div>
                         <?php endif; ?>
