                            ...
                            <div class="input-style input-style-always-active has-borders mb-4">
                                ...
                                <select onchange="getPo()" id="networkid" name="network">
                                    <option value="" disabled="" selected="">Select Slip Design</option>
                                        <option data-price=200 value="regular">Regular Slip</option>
                                        <option data-price=200 value="standard">Standard Slip</option>
                                        <option data-price=250 value="premium">Premium Slip</option>
                                </select>
