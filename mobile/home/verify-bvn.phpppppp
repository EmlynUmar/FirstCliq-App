        ...
        <div class="card card-style">
            ...
            <div class="content">
                ...
                <p class="mb-0 text-center font-600 color-highlight">Verify and Print BVN Slips</p>
                <h1 class="text-center">BVN Verifications</h1>
                ...
                <form method="post" class="verifyForm" id="verifyForm" action="verify-bvn">
                        <fieldset>
                            ...
                            <div class="input-style input-style-always-active has-borders mb-4">
                                ...
                                <select onchange="getPo()" id="networkid" name="network">
                                    <option value="" disabled="" selected="">Select Slip Design</option>
                                        <option data-price=150 value="regular">Information Slip</option>
                                </select>
                            ...
                            <div class="input-style input-style-always-active has-borders validate-field mb-4">
                                <label for="phone" class="color-theme opacity-80 font-700 font-12">BVN Number</label>
                                <input type="number" name="phone" placeholder="BVN Number" value="" class="round-small" id="phone" required  />
                            </div>
                            ...
                            <button type="submit" id="verify-bvn" name="verify-bvn" style="width: 100%;" class="btn btn-full btn-l font-600 font-15 gradient-highlight mt-4 rounded-s">
                                   Verify BVN
                            </button>
                            </div>
                        </fieldset>
