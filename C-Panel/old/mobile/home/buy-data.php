...
<div class="page-content header-clear-medium">
                    ...
                    <div class="input-style input-style-always-active has-borders mb-4">
                        ...
                        <select id="networkid" name="network">
                            ...
                            <?php foreach ($data as $network) : if ($network->networkStatus == "On") : ?>
                                    <option value="<?php echo $network->nId; ?>" networkname="<?php echo $network->network; ?>" sme="<?php echo $network->smeStatus; ?>" sme2="<?php echo $network->sme2Status; ?>" gifting="<?php echo $network->giftingStatus; ?>" corporate="<?php echo $network->corporateStatus; ?>" corporate2="<?php echo $network->corporate2Status; ?>" coupon="<?php echo $network->couponStatus; ?>">
                            ...
                            <div class="input-style input-style-always-active has-borders mb-4">
                                ...
                                <select id="datagroup" name="datagroup">
                                    ...
                                    <option value="Coupon">Data Coupon</option>
                                </select>
                                <span><i class="fa fa-chevron-down"></i></span>
                                <i class="fa fa-check disabled valid color-green-dark"></i>
                                <i class="fa fa-check disabled invalid color-red-dark"></i>
        ...
        .input-with-image input[type="text"] {
            padding-left: 100px; /* Adjust as needed based on image size */
        }
          ...
          <div class="input-with-image">
                            <div class="input-style input-style-always-active has-borders validate-field mb-4">
                                ...
                                <input type="number" onkeyup="verifyNetwork()" name="phone" placeholder="Phone Number" value="" class="round-small" id="phone" required="">
                                   <img id="openContacts" src="https://jabbodata.com.ng/test/contact.png" onclick="openContactPicker()">
                            </div>
                            </div>
