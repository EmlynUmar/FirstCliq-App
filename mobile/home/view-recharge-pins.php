    ...
    <div class="card card-style">
        <div class="content">
            <div class="d-flex justify-content-between mb-0">
                <div>
                    <p class="mb-0 font-300 color-highlight">Transaction Details</p>
                    <h1>Recharge Pin</h1>
                </div>
                <div>
                        ...
                        <div class="row border" style="margin: 3px;">
                            <div class="col-4" style="margin: 0; padding: 0; background-color:<?php echo $cardColor; ?>;">
                                <div class="text-dark" style="padding: 10px;">
                                    <p style="margin-bottom: 5px;"><img src="../../assets/images/icons/<?php echo $cardLogo; ?>" style="width: 70px; height: 70px;" /></p>
                                    <h6 style="color:<?php echo $textColor; ?>">RECHARGE</h6>
                                    <h6 style="color:<?php echo $textColor; ?>"><?php echo $dataaize; ?></h6>
