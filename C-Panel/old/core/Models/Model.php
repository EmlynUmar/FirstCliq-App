<?php
	...
	class Model{
		...
		public static $dbName="dataflex_express"; //Database Name
		public static $username="dataflex_express"; // Database Username
		public static $password="dataflex_express"; //Database Password
