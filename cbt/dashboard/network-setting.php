...
<div class="form-group col-md-4">
                    <label for="success" class="control-label"><?php echo $_GET["network"]; ?> Coupon</label>
                    <div class="">
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="">
                        <input type="number" name="networkid" value="<?php echo $network->networkid; ?>" class="form-control" placeholder="general ID" required />
                    </div>
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="">
                        <input type="number" name="sme2Id" value="<?php echo $network->sme2Id; ?>" class="form-control" placeholder="SME2 ID" required />
                    </div>
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="">
                        <input type="number" name="couponId" value="<?php echo $network->couponId; ?>" class="form-control" placeholder="SME ID" required />
                    </div>
                </div>
