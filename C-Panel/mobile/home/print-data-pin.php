            ...
            <div class="content">
                <div class="row">
                    ...
                    <?php if(!empty($data)) : $pins=explode(",",$data->tokens); $sn=explode(",",$data->serial); ?>
                        ...
                        <?php if($network == "AIRTEL"){$cardColor="#ff1a1a"; $cardLogo="airtel.png"; $textColor="#ffffff"; $checkBal="*310#";} 
                            elseif($network == "GLO"){$cardColor="#60cf06"; $cardLogo="glo.png"; $textColor="#ffffff"; $checkBal="*310#";} 
                            elseif($network == "9MOBILE"){$cardColor="##047d0c"; $cardLogo="9mobile.png"; $textColor="#ffffff"; $checkBal="*310#";} 
                            ...
                            <div class="row" style="margin:3px; margin-top:5px; margin-bottom:5px;">
                                    ...
                                    <div class="col-4" style="margin:0; padding:0; background-color:<?php echo $cardColor; ?>; ">
                                        <div class="text-dark" style="padding:5px;">
                                            ...
                                            <h6 style="color:<?php echo $textColor; ?>; font-size:13px;">RECHARGE PIN <?php echo $datasize; ?></h6>
