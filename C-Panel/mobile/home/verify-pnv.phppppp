            ...
            <div class="content">
                ...
                <form method="post" class="verifyForm" id="verifyForm" action="verify-pnv">
                        <fieldset>
                            ...
                            <div class="input-style input-style-always-active has-borders mb-4">
                                ...
                                <select onchange="getPo()" id="networkid" name="network">
                                    <option value="" disabled="" selected="">Select Slip Design</option>
                                        <option data-price=300 value="regular">Regular Slip</option>
                                        <option data-price=300 value="standard">Standard Slip</option>
                                        <option data-price=300 value="premium">Premium Slip</option>
                                </select>
                            ...
                            <button type="submit" id="verify-pnv" name="verify-pnv" style="width: 100%;" class="btn btn-full btn-l font-600 font-15 gradient-highlight mt-4 rounded-s">
                                   Verify Phone Number
                            </button>
                            </div>
                        </fieldset>
