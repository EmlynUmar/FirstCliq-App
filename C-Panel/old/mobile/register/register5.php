                ...
                <form id="reg-form" method="post">
                    <div id="regDiv">
                        <div class="form-group">
                            ...
                            <input type="text"maxlength="10" name="fname" id="fname" class="form-control"  placeholder="First Name" required>
                        </div> 

                        <div class="form-group">
                            <i class="la la-user"></i> &nbsp &nbsp
                            <label for="">Last Name</label> <br>
                            <input type="text"maxlength="10" name="lname" id="lname" class="form-control"  placeholder="Last Name" required>
                        </div> 
