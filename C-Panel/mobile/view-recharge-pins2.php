        ...
        <table class=' w3-table-responsive' id="pins">
            ...
            <tr>
                ...
                <td>
                 ...
                 <div class="content" style="padding-left: 10px;margin-top:-19px;"><span><b>REF:</b></span> &nbsp;&nbsp;  <span> <b>51128</b></span> <br></br>
                    <span><b>PIN:</b></span>&nbsp;&nbsp;<span style="font-size:11px"><b> <?php echo trim($pins[$i]); ?>
</b></span><br>
