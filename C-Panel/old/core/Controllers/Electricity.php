<?php
    ...
    class Electricity extends ApiAccess{
		...
		public function validateMeterNumber($body,$electricityid,$provider){
            ...
            //Get Ap Details
            $host = $this->getConfigValue($details,"meterVerificationProvider");
            $apiKey = $this->getConfigValue($details,"meterVerificationApi");
		...
		public function purchaseElectricityToken($body,$electricityid,$provider){
            ...
            //Get Ap Details
            $host = $this->getConfigValue($details,"meterProvider");
            $apiKey = $this->getConfigValue($details,"meterApi");
