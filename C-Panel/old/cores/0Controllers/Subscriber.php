<?php
	...
	class Subscriber extends Controller{
		...
		public function purchaseAirtime(){
			extract($_POST);
			$this->setDetails();
			$host = $this->siteurl."/@@2700/airtime/";
			$transkey=strip_tags($transkey);
			$check=$this->model->verifyTransactionPin($this->userId,$transkey);
			$ported_number = "false";
		...
		public function purchaseRechargePin(){
			extract($_POST);
			$host = $this->siteurl."/@@2700/rechargepin/";
			$transkey=strip_tags($transkey);
			$check=$this->model->verifyTransactionPin($this->userId,$transkey);
			$ported_number = "false";
		...
		public function purchaseAlphaTopup(){
			extract($_POST);
			$host = $this->siteurl."/@@2700/alphatopup/";
			$transkey=strip_tags($transkey);
			$check=$this->model->verifyTransactionPin($this->userId,$transkey);
			$ported_number = "false";
		...
		public function purchaseDataPin(){
			extract($_POST);
			$host = $this->siteurl."/@@2700/datapin/";
			$transkey=strip_tags($transkey);
			$check=$this->model->verifyTransactionPin($this->userId,$transkey);
			$ported_number = "false";
		...
		public function validateMeterNumber(){
			extract($_POST);
			$host = $this->siteurl."/@@2700/electricity/verify/";
		...
		public function purchaseElectricityToken(){
			extract($_POST);
			$host = $this->siteurl."/@@2700/electricity/";
			$transkey=strip_tags($transkey);
			$check=$this->model->verifyTransactionPin($this->userId,$transkey);
		...
		public function purchaseCableTv(){
			extract($_POST);
			$host = $this->siteurl."/@@2700/cabletv/";
			$transkey=strip_tags($transkey);
			$check=$this->model->verifyTransactionPin($this->userId,$transkey);
		...
		public function validateIUCNumber(){
			extract($_POST);
			$host = $this->siteurl."/@@2700/cabletv/verify/";
			$data = $this->getProfileInfo();
