...
<div class="card-top p-3">
<h5 class="font-monospace opacity-70 font-10 mb-0 color-white">Account</h5>
<h2 class="color-white font-30">Paga Bank</h2>
</div>
<div class="card-bottom p-3">
<h5 class="font-monospace opacity-70 font-10 mb-n1 color-white">Account Number</h5>
<h5 class="font-monospace font-14 color-white" onclick="copyToClipboard('<?php echo $data->sPagaBank; ?>')"><?php echo $data->sPagaBank; ?></h5>
</div>
<div class="card-top p-3">
<h5 class="text-end font-monospace opacity-70 font-10 mb-n1 color-white">Charges</h5>
<h5 class="text-end font-monospace font-14 color-white">15 naira</h5>
</div>
...
<center>
         ...
         <div class="card card-style">
            ...
            <div>
             ...
             <a href="https://play.google.com/store/apps/details?id=com.agdatasub.com"  <div class="text-center"><img src="../../assets2/images/dapp.png" style="width:512px; height:250px;" /></div></a>
        </div>
                </div>
                </div>
