    ...
    class BVN extends ApiAccess{
		...
		public function verifyMyBVN($body,$networkDetails){
            ...
            CURLOPT_HTTPHEADER => array(
                ...
                "Authorization: Bearer lv_aspget_9486pj03r3hn4g"
            ),
            ));
            ...
            if($result->status==true || $result->status=='success'){
                ...
                $uslip = "https://agdatasub.com/slips/bvn/?reportID=".$body->ref."&preview=1";
                $data = '
                {
                    "filepath":"'.$uslip.'",
                    "pagesize":"A4",
                ...
                if($respJ->convertedFilePath){
                    ...
                    curl_close ($ch);
                    fclose($fp);
                    $pdfURL = "https://agdatasub.com/slips/bvn/".$pdfName;
