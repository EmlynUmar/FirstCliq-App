    ...
    class PNV extends ApiAccess{
		...
		public function verifyMyPNV($body,$networkDetails){
            ...
            CURLOPT_HTTPHEADER => array(
                ...
                "Authorization: Bearer lv_aspget_9486pj03r9s7qt1xzcfvk17ube53hn4g"
            ),
            ));
            ...
            if($result->status==true || $result->status=='success'){
                ...
                $uslip = "https://expressdata.ng/slips/nin/{$slip}/?reportID=".$body->ref."&preview=1";
                $data = '
                {
                    "filepath":"'.$uslip.'",
                    "pagesize":"A4",
                ...
                if($respJ->convertedFilePath){
                    ...
                    curl_close ($ch);
                    fclose($fp);
                    $pdfURL = "https://expressdata.ng/slips/nin/{$slip}/".$pdfName;
