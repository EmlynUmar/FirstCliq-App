<?php
	...
	class Subscriber extends Controller{
		...
		public function purchaseAirtime(){
			extract($_POST);
			$this->setDetails();
			$host = $this->siteurl."/@@2800/airtime/";
		...
		public function purchaseRechargePin(){
			extract($_POST);
			$host = $this->siteurl."/@@2800/rechargepin/";
	...
	//Send Bulk Sms
		public function purchasebulksms(){
			extract($_POST);
			$host = $this->siteurl."/@@2800/bulksms/";
    ...
    return $transref;
       ...
       $transrer = generatebulkref();
		...
		public function purchaseAlphaTopup(){
			extract($_POST);
			$host = $this->siteurl."/@@2800/alphatopup/";
			$transkey=strip_tags($transkey);
			$check=$this->model->verifyTransactionPin($this->userId,$transkey);
			$ported_number = "false";
		...
		public function purchaseDataPin(){
			extract($_POST);
			$host = $this->siteurl."/@@2800/datapin/";
			$transkey=strip_tags($transkey);
			$check=$this->model->verifyTransactionPin($this->userId,$transkey);
			$ported_number = "false";
		...
		public function validateMeterNumber(){
			extract($_POST);
			$host = $this->siteurl."/@@2800/electricity/verify/";
		...
		public function purchaseElectricityToken(){
			extract($_POST);
			$host = $this->siteurl."/@@2800/electricity/";
			$transkey=strip_tags($transkey);
			$check=$this->model->verifyTransactionPin($this->userId,$transkey);
   ...
   //Get Total Spent In A Month
     function monthlySpent(){
		...
		public function purchaseCableTv(){
			extract($_POST);
			$host = $this->siteurl."/@@2800/cabletv/";
			$transkey=strip_tags($transkey);
			$check=$this->model->verifyTransactionPin($this->userId,$transkey);
		...
		public function validateIUCNumber(){
			extract($_POST);
			$host = $this->siteurl."/@@2800/cabletv/verify/";
			$data = $this->getProfileInfo();
		...
		public function generatePaga(){
		    $this->model->generatePaga($this->userId);
		} 
			//Generate aspfiy Account
		
		public function generateDynamicSafeHaven(){
		    $this->model->generateDynamicSafeHaven($this->userId);
		}
		...
		public function purchaseSmileData(){
			extract($_POST);
			$host = $this->siteurl."/@@2800/smile-data/";
